...
Module.register("MMM-EFA-departures",
{
    ...
    /* manipulate the dom
     *
     * return string - return the wrapper.
     */
    getDom: function ()
    {
        ...
        else
        {
            ...
            // classie substitute with https://www.w3schools.com/howto/howto_js_toggle_class.asp ?!?!
    ...
    /*
     * For each color in config this function checks
     * if this color is supportet by CSS
     *
     * argument key string - The key to check
     *
     * return key - The checked or the default key.
     */
    ...
    /*
     * For each train type set the color defined in config
     *
     * argument name string - The name to set color
     * argument type string - The type to set color
     *
     * return style - the style wich is returned or the default style.
     */
