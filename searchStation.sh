...
function stationsearchbynameFunction {
	...
	# get result from name with curl and save to temp json file; -# means that is schon a progressbar during download instead the full context; -H means header injection; -s means silent, possible to use instead of -#
